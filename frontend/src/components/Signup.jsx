...
export default function Signup() {
  return (
    <div className="">
      <div className="h-full p-6 w-full bg-gray-900 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-10 ">
        ...
        <form className="flex flex-col gap-3">
          ...
          <label className="input input-bordered flex items-center gap-2">
            ...
            <input type="password" className="grow" placeholder="Conform Password" name="conformPassword" />
          </label>
